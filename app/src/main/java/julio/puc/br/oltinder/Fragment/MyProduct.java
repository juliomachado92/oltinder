 ...
 * {@link MyProduct.OnFragmentInteractionListener} interface
...
public class MyProduct extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        txtName = (TextView)view.findViewById(R.id.txtNameClient);
        listViewProducts = (ListView) view.findViewById(R.id.listClientProducts);
        productList = new ArrayList<>();

        adapter = new ProductAdapter(MainActivity.myProducts,getContext());
