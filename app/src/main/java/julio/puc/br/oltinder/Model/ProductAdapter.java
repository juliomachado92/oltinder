...
public class ProductAdapter extends BaseAdapter{
   ...
   // private ImageView imgProduct;
    ...
    public View getView(int position, View convert, ViewGroup parent) {
        ...
        View view = mInflater.inflate(R.layout.list_product, null);
        ...
        ImageView imgProduct = (ImageView)view.findViewById(R.id.imgListProduct);
        ...
        imgProduct.setImageBitmap(donwloadFileTask.image);
